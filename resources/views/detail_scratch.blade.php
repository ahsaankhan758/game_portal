...
<body>
    <?php echo $child; ?>
            ...
            <div class="">
            <a  href="{{URL::to('scratch_card')}}" class="btn btn-primary ">Add a new Data</a>
            </div>
            ...
            <tr class="gradeX">
                <td>{{$row->scratch_id}}</td>
                <td>{{$row->title}}</td>
                <td>{{$row->prize}}</td>
                <td><img src="{{ asset('storage/'.$row->thumbnail_img) }}" width="90px" height="50px"></td>
                <td class="center">
                    <a href="" class="btn btn-danger btn-circle"><i class="fa fa-times"></i></a>
                    <a href="" class="btn btn-success btn-circle"><i class="fa fa-check"></i></a>
                </td>
            </tr>
              @endforeach
